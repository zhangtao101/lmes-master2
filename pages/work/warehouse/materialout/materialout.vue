			...
			<view class="warehouse-info">
				<view class="header">
					<view class="left">
						...
						<text>领料单：{{formCode}}</text>
					</view>
				</view>
			<view class="scan-input-row">
				<input class="scan-input" v-model="formInput" placeholder="请输入或扫描领料单" @confirm="onFormInputConfirm" />
				...
				<view class="body-header" v-if="formData.details && formData.details.length > 0">
					<view class="body-header-row body-header-title">
						<view class="body-header-cell">物料编号</view>
						<view class="body-header-cell">物料名称</view>
						<view class="body-header-cell">待领数量</view>
						<view class="body-header-cell">已领数量</view>
					</view>
